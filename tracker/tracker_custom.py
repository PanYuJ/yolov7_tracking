...
Original file is located at
    https://colab.research.google.com/drive/1MJyj-pvrSdCVyC4tVFtPkH_pkL5avps2
"""
...
import sys
import os
sys.path.append('/content/Yolov7-tracker/tracker')
import numpy as np
import torch
import cv2 
    ...
    if opts.track_dataset == 'Webcam':
        ...
        while cap.isopened():
          if cv2.waitKey(1) & 0xFF == ord('q'):
            break
          succes, frame0 = cap.read()
          frame = cv2.resize(np.copy(frame),shape=(800,800))
          current_tracks = tracker_inference(model, tracker, frame, frame0, device)
          ...
          plot_img(img0, frame_id, [cur_tlwh, cur_id, cur_cls], save_dir=None, show_image=True))
...
def plot_img(img, frame_id, results, save_dir=None, show_image=False):
    """
...
if __name__ == '__main__':
    ...
    # args=['--dataset','/content/Yolov7-tracker/tracker/config_files/yolov7_track_custom.yaml',
    #     '--data_format', 'yolo', 
    #     '--tracker', 'bytetrack',
    #     '--model_path', '/content/gdrive/MyDrive/project/other/yolov7_tiny_best.pt',
    #     '--img_size', '1280','1280',
    #     '--track_eval', 'False',
    #     '--save_videos'
    #     '--track_dataset', 'seg'
    ...
    with open(f'{opts.dataset}', 'r') as f:
